...
class Point3D private constructor(
    ...
    fun isLowerThan(other: Point3D): Int =
        z.compareTo(other.z)
    ...
    fun move(axis: Axis, steps: Int): Point3D =
        Point3D(
    ...
    companion object {
        fun from(x: Int, y: Int, z: Int): Point3D =
            Point3D(x, y, z)
        ...
        object CompareX: Comparator<Point3D> {
            override fun compare(one: Point3D, other: Point3D): Int =
                one.z.compareTo(other.z)
        }
